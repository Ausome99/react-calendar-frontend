...
export default class CalendarBox extends Component {
    ...
    componentDidMount() {
        if (!this.props.overflow) {
            ...
            fetch(`https://react-calendar-api-alm.herokuapp.com/reminder/get/${date}/${month}/${year}`, { method: "GET" })
    ...
    handleSubmit() {
        ...
        fetch(`https://react-calendar-api-alm.herokuapp.com/reminder/${endpoint}`, {
            method: method,
